...
const Login = () => {
    ...
    const handleLogin = (e) => {
        ...
        // API call (same style as your reference)
        const loginDetails = axios.post("http://localhost:3000/login", {
            email: email,
            password: password,
        });

        loginDetails.then(function (res) {
    ...
    return (
        <>
            ...
            <div
                ...
                style={{
                    backgroundImage:
                        "url('https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?q=80&w=870&auto=format&fit=crop&w=1600&q=80')",
                }}
            >
                
                <h1 className="absolute top-5 left-5 text-2xl font-bold text-red-600">
                    NETFLIX CLONE
                </h1>
